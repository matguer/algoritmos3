...
Dados un offset $o$ y una lista ordenada de manera creciente $l$ y sea $S$ el subconjunto de posibles sublistas expresada como % $S={s_i = [e \rightarrow l| l_i \leqslant e \leqslant l_i + o]} \forall 0 \leqslant i \leqslant long(l)$.
...
Miremos ambos casos:
\begin{itemize}
\item %inicio $\eq a_1$. En este caso a pertenecer\'ia a S, ya que considera como inicio del rango a un elemento de l.
\item 
\end{itemize}
